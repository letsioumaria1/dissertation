...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFA4D8E1);
  late Color secondary = const Color(0xFFF2B2D4);
  late Color tertiary = const Color(0xFFC889D2);
  late Color alternate = const Color(0xFF54D3A2);
  late Color primaryText = const Color(0xFF2C3E50);
  late Color secondaryText = const Color(0xFF7F8C8D);
  late Color primaryBackground = const Color(0xFFF9FAFB);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFFF6F61);
  late Color accent2 = const Color(0xFF772F82);
  late Color accent3 = const Color(0xFF369C92);
  late Color accent4 = const Color(0xFFF79991);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF6BD4E5);
  late Color secondary = const Color(0xFFEAB8D1);
  late Color tertiary = const Color(0xFFD1A7D1);
  late Color alternate = const Color(0xFF8AD9D9);
  late Color primaryText = const Color(0xFF2E2E2E);
  late Color secondaryText = const Color(0xFF575757);
  late Color primaryBackground = const Color(0xFF1F1F1F);
  late Color secondaryBackground = const Color(0xFF2C2C2C);
  late Color accent1 = const Color(0xFFD45D49);
  late Color accent2 = const Color(0xFFF9A825);
  late Color accent3 = const Color(0xFF009688);
  late Color accent4 = const Color(0xFFE57373);
