...
import '/components/heart_rate_weekly_widget.dart';
...
class _HeartRateWidgetState extends State<HeartRateWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<TodayFitbitMetricsRow>>(
      future: TodayFitbitMetricsTable().queryRows(
        queryFn: (q) => q
            .eqOrNull(
          'user_id',
          currentUserUid,
      ...
      builder: (context, snapshot) {
        ...
        List<TodayFitbitMetricsRow> heartRateTodayFitbitMetricsRowList =
            snapshot.data!;
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          valueOrDefault<String>(
                                            heartRateTodayFitbitMetricsRowList
                                                .elementAtOrNull(0)
                                                ?.metricValue
                                                ?.toString(),
                                            '0',
