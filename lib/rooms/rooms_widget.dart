...
class _RoomsWidgetState extends State<RoomsWidget> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<RoomVisitsDailyRow>>(
      future: RoomVisitsDailyTable().queryRows(
      ...
      builder: (context, snapshot) {
        ...
        List<RoomVisitsDailyRow> roomsRoomVisitsDailyRowList = snapshot.data!;
